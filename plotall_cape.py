...
data_dir = f'{data_dir}/GEOS.fp.fcst.inst3_2d_met_Nx.{f_date[:-1]}+20231224_0900.V01.nc4'
...
for region in regions:
    ...
    # Initialize CAPE plotter and plot data
    cape_plotter = Plotter('plotall_cape', region, file_tag, target_proj, proj_name)
    cape_plotter.render(data, cmap, norm)
    ...
    annotate(f'tmp/{proj_name}-cape-{file_tag}.png', 'plotall_cape', mode=mode, forecast=forecast_str, date=date_index)
