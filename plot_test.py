...
Handles aerosols, cape, ir8, precrain
Currently the "plot_data" function does not work which causes the error
...
def plot_ir8():
    # File path for IR8 data
    #data_dir_ir8 = f'{data_dir}/GEOS.fp.fcst.inst_30mn_met_c0720sfc.{f_date[:-1]}+{f_date[:-1]}{minute}.V01.nc4'

    data_dir_ir8 = f'{data_dir}/stockv12-2024Jul04-1day-c24.geosgcm_surf.20000415_1930z.nc4'
