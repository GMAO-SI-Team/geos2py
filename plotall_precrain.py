...
cube = loading.load_cube(data_dir, 'PRECTOT', 1e15, no_map_set=True, pixel=True, scale_factor=3600/25.4)
...
for region in regions:
    ...
    # Initialize rain plotter and plot data
    rain_plotter = Plotter('plotall_precrain', region, file_tag, target_proj, proj_name)
    rain_plotter.render(acc_data, cmap, norm)
    ...
    annotate(f'tmp/{proj_name}-precrain-{file_tag}.png', 'plotall_precrain', mode=mode, forecast=forecast_str, date=date_index)
