...
for region in regions:
    ...
    # Initialize water plotter and plot data
    tpw_plotter = Plotter('plotall_tpw', region, file_tag, target_proj, proj_name)
    tpw_plotter.render(data, cmap, norm)
    ...
    annotate(f'tmp/{proj_name}-tpw-{file_tag}.png', 'plotall_tpw', mode=mode, forecast=forecast_str, date=date_index)
